...
SAVEPOINT action_inserted;

INSERT INTO swoop.thread VALUES (
  '2023-04-28 15:49:00+00',
  '2023-04-28 15:49:00+00',
  '2595f2da-81a6-423c-84db-935e6791046e',
  'handler_foo',
...
/* Set invalid_after to an arbitrary date far in the future for
 a payload_uuid, and set the corresponding thread for the action
associated with that payload_uuid to a FAILED state
*/

UPDATE swoop.payload_cache SET invalid_after = '2999-01-01 00:00:00+00'
...
ROLLBACK TO SAVEPOINT action_inserted;
...
ROLLBACK TO SAVEPOINT payload_inserted;
...
ROLLBACK TO SAVEPOINT nothing_inserted;
...
RELEASE SAVEPOINT nothing_inserted;
